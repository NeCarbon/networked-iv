...
#define TASK_COMPLEX_PLAYER_IDLES 8 // Use this to cancel idle anims (Look at mta)?
...
#define TASK_COMPLEX_GANG_DRIVEBY 740 // Use this to sync drive bys like mta does?
