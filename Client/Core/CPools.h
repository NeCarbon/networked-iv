...
{
private:
	static CIVPool<IVPed>     * m_pPedPool;
	static CIVPool<IVVehicle> * m_pVehiclePool;
	//#define VAR_BuildingPool_7 0x168FED0
	//#define VAR_ObjectPool_7 0x1350CE0
	static CIVPool<IVTask>    * m_pTaskPool;
	//#define VAR_EventPool_7 0x152F4B4
	//#define VAR_CamPool_7 0x1618020
	//#define VAR_TaskInfoPool_7 0x1618040
...
public:
	...
	// Pools
	static CIVPool<IVPed>     * GetPedPool() { return m_pPedPool; }
	static CIVPool<IVVehicle> * GetVehiclePool() { return m_pVehiclePool; }
	static CIVPool<IVTask>    * GetTaskPool() { return m_pTaskPool; }
