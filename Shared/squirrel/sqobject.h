...
struct SQObjectPtr : public SQObject
{
	...
	inline bool operator==(const SQObjectPtr& obj)
	{
		if(_type==obj._type&&_type==OT_CLOSURE)
			return _unVal.pClosure==obj._unVal.pClosure;
		else if(_type==obj._type&&_type==OT_NATIVECLOSURE)
			return _unVal.pNativeClosure==obj._unVal.pNativeClosure;
		assert(0 && "Undefined SqObjectPtr comparison (equal)");
		return false;
	}
